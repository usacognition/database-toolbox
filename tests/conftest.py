...
BIGQUERY_MCP_URL = os.getenv("BIGQUERY_MCP_URL", "http://localhost:5004")
ALLOYDB_MCP_URL = os.getenv("ALLOYDB_MCP_URL", "http://localhost:5005")
SPANNER_MCP_URL = os.getenv("SPANNER_MCP_URL", "http://localhost:5006")
NEO4J_MCP_URL = os.getenv("NEO4J_MCP_URL", "http://localhost:5007")
SQLITE_MCP_URL = os.getenv("SQLITE_MCP_URL", "http://localhost:5008")
REDIS_MCP_URL = os.getenv("REDIS_MCP_URL", "http://localhost:5009")
SQLSERVER_MCP_URL = os.getenv("SQLSERVER_MCP_URL", "http://localhost:5010")
FIRESTORE_MCP_URL = os.getenv("FIRESTORE_MCP_URL", "http://localhost:5011")
SUPABASE_MCP_URL = os.getenv("SUPABASE_MCP_URL", "http://localhost:5012")
